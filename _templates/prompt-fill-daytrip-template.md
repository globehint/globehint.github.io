...
**Research standard**: every price, time, distance, and transport detail must be something you're confident is accurate, not invented to sound plausible. Use realistic ranges over fabricated precision where you're unsure. End your response with a "Verify before publishing" list of anything time-sensitive (ticket prices, seasonal train schedules, opening hours).
...
4. Getting There & Around: real transport options from [BASE CITY] with time/cost/notes, plus getting-around-once-there info.
5. Suggested Itinerary: a realistic hour-by-hour or stop-by-stop plan that fits within the stated duration.
6. Eat & Drink, Photogenic Spots, Language, Tips & Tricks: same standard as the main guide template - specific, real, no filler.
